...
# Test MCP Registry API Endpoints
...
echo -e "${BLUE}🧪 Testing MCP Registry API${NC}"
echo -e "${BLUE}========================${NC}"
...
echo -e "${BLUE}8️⃣ Get Non-existent Server (should return 404)${NC}"
...
if [ "$http_code" = "404" ]; then
    echo -e "${GREEN}✓ Success - correctly returned 404${NC}"
else
    echo -e "${YELLOW}⚠ HTTP Code: ${http_code} (expected 404)${NC}"
fi
echo ""
